...
:::note
We don't currently support binary in vals, but we plan to at some point. Upvote and comment on [this GitHub discussion](https://github.com/val-town/val-town-product/discussions/21) if that's something you'd like to see soon!
:::
