...
Townie currently only creates [HTTP vals][], but you can simulate [script][script vals] or [cron vals][] by making a simple site with a trigger button. Once you have code working the way you like, you can manually change the val type to make it function as a cron or standalone script val.
