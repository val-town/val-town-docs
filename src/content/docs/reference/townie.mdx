...
and the built-in [SQLite][/std/sqlite/] storage for persisting data.
...
You can ask Townie "to make changes as unified diffs." For small changes, this works well, but can be error prone on larger diffs or when Townie hallucinates.
