...
If you have questions or bugs to report, you can email [support@val.town](mailto:support@val.town), [open a GitHub issue](https://github.com/val-town/val-town-product/issues), or [send a message in Discord](https://discord.val.town).
