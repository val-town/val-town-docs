...
Powered by the Claude 4.5 family and our [MCP server](/guides/prompting/mcp). Available on Val Town Teams and Pro plans. Click the little robot in the bottom right corner on [val.town](https://val.town) to get started.
...
- The Townie [system prompt](https://val.town/townie/system-prompt) is public if you are curious to peak under the hood
