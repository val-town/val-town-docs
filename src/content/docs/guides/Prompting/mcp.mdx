...
Use the Val Town MCP server to work with Val Town in your preferred AI tool, e.g. with [Claude Code](/guides/prompting/claude-code#mcp). Our MCP server also powers [Townie](/guides/prompting/townie), which you can use in Val Town alongside the val editor.
