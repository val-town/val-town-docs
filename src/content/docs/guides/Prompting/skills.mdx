...
Whenever you are chatting with Townie or another agent using our MCP server, your agent instructions will automatically be available in context.
...
You may choose to centralize your skills in one val or colocate skills across multiple vals. For example, you could expose a design skill in any val, like `skills/design/SKILL.md`:
