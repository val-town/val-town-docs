...
_You can also give our [**Val to Project Converter [Beta]**](https://charmaine-valtoproject.web.val.run/) a try. It should complete steps 1-2 below for you automatically._
...
### Redirect your vals
After all the vals are now saved and working in a new project, update the old vals to redirect future usage.
