---
title: Utils
description: Utils for reading, serving, testing val files & more
---

import { LinkCard } from "@astrojs/starlight/components";

The Val Town standard library comes with a suite of functions to handle files and metadata.

<LinkCard
  title="std/utils"
  description="readFile, serveFile, parseVal, httpEndpoint, emailAddress, getContentType, ..."
  href="https://www.val.town/x/std/utils"
/>

## File Operations

Utilities for reading and managing files in vals.
