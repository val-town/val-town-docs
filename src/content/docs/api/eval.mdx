...
<vt-playground id="playground" code={`import { fetchJSON } from "https://esm.town/v/stevekrouse/fetchJSON";

export let evalPost1 = await fetchJSON(
...
export let evalPost2 = await fetchJSON(
  "https://api.val.town/v1/eval",
  {
    method: "POST",
