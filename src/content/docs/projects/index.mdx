...
<CardGrid>
  <LinkCard
    ...
    href="/docs/projects/branches"
  />
  <LinkCard
    title="Forks"
    description="Fork another user's project to make changes and send a pull request"
    href="/docs/projects/forks"
  />
</CardGrid>
...
- Binary files are not supported. We reccomend [Blob Storage](/std/blob).
