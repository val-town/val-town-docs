...
<Val url="https://www.val.town/embed/x/valdottown/HTTP_examples/Routing/honoExample" height="240px" />

### Peko

And one with [Peko](https://peko.deno.dev/):

<Val url="https://www.val.town/embed/x/valdottown/HTTP_examples/Routing/pekoExample" height="300px" />

### nhttp

And [nhttp](https://github.com/nhttp/nhttp):

<Val url="https://www.val.town/embed/x/valdottown/HTTP_examples/Routing/nhttpExample" height="350px" />

### itty-router

A super tiny example with [itty-router](https://itty.dev/itty-router):

<Val url="https://www.val.town/embed/x/valdottown/HTTP_examples/Routing/ittyExample" height="250px" />
