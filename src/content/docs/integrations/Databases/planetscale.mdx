...
<Val url="https://www.val.town/embed/vtdocs.planetScaleCreateStockTable" />

## 5. Insert an item

Insert one or more items.

<Val url="https://www.val.town/embed/vtdocs.planetScaleInsertStockTable" />
...
<Val url="https://www.val.town/embed/vtdocs.planetScaleSelectStockTable" />
