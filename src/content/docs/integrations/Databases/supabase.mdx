...
<Val url="https://www.val.town/embed/vtdocs.supabaseSDKInsertIntoMyFirstTable" />

### 6. Query back that data

Get back the data you just inserted by using `eq()` (like SQL’s `WHERE`).

<Val url="https://www.val.town/embed/vtdocs.supabaseSDKSelectMyFirstTable" />
...
<Val url="https://www.val.town/embed/vtdocs.supabaseCreateMyFirstTable" />
...
<Val url="https://www.val.town/embed/vtdocs.supabaseInsertIntoMyFirstTable" />

### 6. Query back that data

Usually, you’ll just want the `rows` property from the response.

<Val url="https://www.val.town/embed/vtdocs.supabaseSelectMyFirstTable" />
