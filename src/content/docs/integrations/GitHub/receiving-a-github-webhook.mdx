...
<Val url="https://www.val.town/embed/neverstew.githubStarWebhook" />
...
[secrets](/reference/environment-variables/) on Val Town as `githubWebhookToken`.
...
<Val url="https://www.val.town/embed/vtdocs.verifyGithubWebhookSignature" />

It can be integrated into the original example like this:

<Val url="https://www.val.town/embed/neverstew.githubWebhookWithVerify" />
