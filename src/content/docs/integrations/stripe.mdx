...
You can accept payments in Val Town. With this guide, you'll be able to use Payment Links to accept payments in Val Town using Stripe.
...
```Create a tipping app with Stripe Checkout in the server. Use tailwind css for styling and make the buttons purple. The preset tip options should be 1, 5, 10, 20.```
