...
![Message sent](../../quickstarts/_slack-assets/send-messages-to-slack/sample-message.png)
...
![Create Slack app](../../quickstarts/_slack-assets/send-messages-to-slack/app.png)

**Enable incoming webhooks:**
1. Go to **Features → Incoming Webhooks**
2. Toggle **Activate Incoming Webhooks**

![Enable incoming webhooks](../../quickstarts/_slack-assets/send-messages-to-slack/incoming-webhook.png)
...
![Copy webhook URL](../../quickstarts/_slack-assets/send-messages-to-slack/env-var.png)
