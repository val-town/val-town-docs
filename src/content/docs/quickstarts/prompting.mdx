...
### General LLM use
Use our [llms.txt](../../llms.txt) and [llms-full.txt](../../llms-full.txt) with your preferred LLM.  The [llms.txt standard](https://llmstxt.org/) provide structured information to help LLMs understand the Val Town project.

You can also click `Copy page [in markdown]` or `Open in ChatGPT` on the top right of any docs page to chat about Val Town with any LLM.
